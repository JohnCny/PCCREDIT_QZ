...
public class UploadDeamonService{
	...
	public void doUpload(){
		//前一次任务未完跳过本次
		logger.info("getActiveCount():" + taskExecutorUpload.getActiveCount());
	...
	public class UploadThread implements Runnable{
		...
		public void run() {
			...
			//上传
			String sql = "select * from QZ_APPLN_ATTACHMENT_DETAIL where is_upload is null and batch_id='"+batch_id+"' order by lsh";
