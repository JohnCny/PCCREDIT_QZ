...
@Controller
@RequestMapping("/intopieces/intopiecestwolevel/*")
@JRadModule("intopieces.intopiecestwolevel")
public class IntopiecesTwolevelControl extends BaseController{
	...
	public static final  Logger logger = Logger.getLogger(IntopiecesTwolevelControl.class);
	 ...
	 */
	@ResponseBody
	@RequestMapping(value = "twolevel.page", method = { RequestMethod.GET })
	public AbstractModelAndView onelevel(@ModelAttribute CustomerApplicationProcessFilter filter, HttpServletRequest request) throws SQLException {
		...
		JRadModelAndView mv = new JRadModelAndView(
				"/intopieces/intopieces_wait/intopiecesApprove_twolevel", request);
