...
*/
@Controller
@RequestMapping("/intopieces/intopiecesdshlevel4/*")
@JRadModule("intopieces.intopiecesdshlevel4")
public class Intopiecesdshlevel4Control extends BaseController{
	...
	public static final  Logger logger = Logger.getLogger(Intopiecesdshlevel4Control.class);
	...
	public AbstractModelAndView browse(@ModelAttribute CustomerApplicationProcessFilter filter, HttpServletRequest request) throws SQLException {
		...
		filter.setNodeName(Constant.status_dsh_level4);
		...
		JRadModelAndView mv = new JRadModelAndView(
				"/intopieces/intopieces_wait/intopiecesApprove_dsh_level4", request);
	...
	public AbstractModelAndView iframeApprove(HttpServletRequest request) {
		...
		if (StringUtils.isNotEmpty(customerInforId)) {
			...
			mv.addObject("operate", Constant.status_dsh_level4);
		}
		return mv;
	}
}
