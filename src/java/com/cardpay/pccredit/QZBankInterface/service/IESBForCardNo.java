...
public class IESBForCardNo {
     ...
     * @return
     */
    public CompositeData createRequest(String client_no){
        ...
        serviceCodeField.setValue("11003000007");//
